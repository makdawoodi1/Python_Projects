...
def guess(x):
    ...
    while guess != random_number:
        ...
        if guess < random_number:
            ...
            elif random_number - guess >= 30 and random_number - guess < 50:
                print('Sorry! You are low.. Please try again :)')
            elif guess - random_number >= 1 and random_number - guess < 30:
            ...
            elif guess - random_number >= 30 and random_number - guess < 50:
...
def computer_guess(x):
    ...
    while guess != 'C':
        ...
        if low != high:
            ...
            guess = low
        feedback = input(f'\nIs {guess} too high (H), too low (L), or correct? ').upper()
    ...
    while True:
        ...
        if try_again == 'y': 
            while True:
                choice choice = int(input('Which game do you want to play? \
1 for (You guess the number) \
2 for (Computer guess the number)?? '))
